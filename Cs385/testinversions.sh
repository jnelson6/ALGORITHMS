...
# TODO - tests that use the 'slow' approach. 
# EXAMPLE - You are allowed up to 8 seconds to count inversions on up to 100,000 values.
...
# TODO - tests that use the 'fast' approach. 
# EXAMPLE - You are allowed up to 1.25 seconds to count inversions on up to 100,000 values.
