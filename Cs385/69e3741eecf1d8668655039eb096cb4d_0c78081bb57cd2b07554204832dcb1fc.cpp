        ...
        while(queue1.size() > 0){
        	...
        	if( temp.a > 0 ){
        		...
        		if( (temp.a + temp.b) <= B ){
        			...
        			toPrint.directions.push_back( "Pour " + to_string(temp.a) + " gallons " + "from A to B. " + toPrint.to_string() );
        			queue1.push(toPrint);
				}
        			...
        			toPrint.directions = temp.directions;
        			toPrint.directions.push_back( "Pour " + to_string( (B - temp.b) ) + " gallons " + "from A to B. " + toPrint.to_string());
        			queue1.push(toPrint);
				}
				...
				if( (temp.a + temp.c) <= C){
        			...
        			toPrint.directions = temp.directions;
        			toPrint.directions.push_back( "Pour " + to_string(temp.a) + " gallons " + "from A to C. " + toPrint.to_string());
        			queue1.push(toPrint);
				}
        			...
        			toPrint.directions = temp.directions;
        			toPrint.directions.push_back( "Pour " + to_string( (C-temp.c) ) + " gallons " + "from A to C. " + toPrint.to_string());
        			queue1.push(toPrint);
				}
			}
			//Empty B
			if(temp.b > 0){
				...
				if((temp.b + temp.a) <= A){
        			...
        			toPrint.directions = temp.directions;
        			toPrint.directions.push_back( "Pour " + to_string(temp.b) + " gallons " + "from B to A. " + toPrint.to_string());
        			queue1.push(toPrint);
				}
        			...
        			toPrint.directions = temp.directions;
        			toPrint.directions.push_back( "Pour " + to_string( (A - temp.a) ) + " gallons " + "from B to A. " + toPrint.to_string());
        			queue1.push(toPrint);
				}
				...
				if((temp.b + temp.c) <= C){
        			...
        			toPrint.directions = temp.directions;
        			toPrint.directions.push_back( "Pour " + to_string(temp.b) + " gallons " + "from B to C. " + toPrint.to_string());
        			queue1.push(toPrint);
				}
        			...
        			toPrint.directions = temp.directions;
        			toPrint.directions.push_back( "Pour " + to_string( (C - temp.c) ) + " gallons " + "from B to C. " + toPrint.to_string());
        			queue1.push(toPrint);
				}
			}
			//Empty C
			if(temp.c > 0){
				...
				if( (temp.c + temp.a) <= A){
        			...
        			toPrint.directions = temp.directions;
        			toPrint.directions.push_back( "Pour " + to_string(temp.c) + " gallons " + "from C to A. " + toPrint.to_string());
        			queue1.push(toPrint);
				}
        			...
        			toPrint.directions = temp.directions;
        			toPrint.directions.push_back( "Pour " + to_string( (A - temp.a) ) + " gallons " + "from C to A. " + toPrint.to_string());
        			queue1.push(toPrint);
				}
				...
				if( (temp.b + temp.c) <= B){
        			...
        			toPrint.directions = temp.directions;
        			toPrint.directions.push_back( "Pour " + to_string(temp.c) + " gallons " + "from C to B. " + toPrint.to_string());
        			queue1.push(toPrint);
				}
        			...
        			toPrint.directions = temp.directions;
        			toPrint.directions.push_back( "Pour " + to_string( (B - temp.b) ) + " gallons " + "from C to B. " + toPrint.to_string());
        			queue1.push(toPrint);
				}
			}
