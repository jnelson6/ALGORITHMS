 ...
 * Version : 1.0
 * Date    : May 11, 2020
 * Description : Scans a dictionary  and finds the longest words that have 1+ 
 *                  anagrams present in the dictionary. 
